...
<p class="card-subtitle">Software Architect · adesso SE</p>
...
<div class="card-grid">
  <div class="card">
    ...
    <div class="card-desc">Software architecture & quality</div>
  </div>
  <div class="card">
    <div class="card-icon">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="card-desc">Fullstack development & developer experience</div>
  </div>
  <div class="card">
    <div class="card-icon">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="card-desc">AI-assisted development</div>
  </div>
</div>
...
<p class="card-subtitle">Co-Founder · Suora</p>
...
<div class="card-grid">
  <div class="card">
    ...
    <div class="card-desc">Building frontend applications since 2007</div>
  </div>
  <div class="card">
    <div class="card-icon">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="card-desc">Frontend architecture & React</div>
  </div>
  <div class="card">
    <div class="card-icon">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="card-desc">Agile processes & team collaboration</div>
  </div>
</div>
